...
public class ReportEventFragment extends Fragment {
    ...
    private FirebaseAuth.AuthStateListener mAuthListener; // login logout
    ...
    private String uploadEvent() {
        ...
        String key = database.child("events").push().getKey(); // compare all data in datasnapshot, and create a new primary key
        event.setId(key);
