package com.example.liuyx.eventreporter;
        ...
        */
        mRegisterButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child("users").addListenerForSingleValueEvent(new ValueEventListener() { // a table called users
                    @Override
                ...
                mDatabase.child("users").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (dataSnapshot.hasChild(username) && (password.equals(dataSnapshot.child(username).child("password").getValue()))) {
                            ...
                            Intent myIntent = new Intent(MainActivity.this, EventActivity.class); // explicit intent
